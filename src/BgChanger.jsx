...
function Btn ({name}) {
    ...
    hover:translate-y-1 hover:border-2 transition-all ease-in-out 0.7s hover:bg-red-400
    focus:bg-black
    " >{name}</button>
    </>
);
  ...
  return (
    <div id='wrap' style={{backgroundColor : color}} className="h-screen bg-slate-800 text-center flex justify-center flex-col place-items-center text-white font-mono  ">
